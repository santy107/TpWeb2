...
<head>
    ...
    <title>Central de descuentos / Carniceria</title>
</head>
<body>
    <!-- ENCABEZADO -->
    <header id="header">
    ...
    <!-- CONTENIDO PRINCIPAL -->
    <h1>Productos de Carnicería</h1>
<?php

    include 'config.php';


    $sql = "SELECT id_producto, producto, precio, imagen FROM descuentos WHERE categoria = 'carnicería'";
    $result = $conexion->query($sql);
    
    if ($result->num_rows > 0) {
        // Generaramos html dinamicamentee con los productos
