...
<head>
    ...
    <title>Central de descuentos / Panaderia</title>
</head>
<body>
    <!-- ENCABEZADO -->
    <header id="header">
    ...
    <!-- CONTENIDO PRINCIPAL -->
    <h1>Productos de Panaderia</h1>
<?php

    include 'config.php';
 $sql = "SELECT id_producto, producto, precio, imagen FROM descuentos WHERE categoria = 'panaderia'";
    $result = $conexion->query($sql);
    
    if ($result->num_rows > 0) {
        // Generamos HTML dinámicamente con los productos
